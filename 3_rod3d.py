...
#node 1,4
fixed_nodes = [0,1,2, 9,10,11, 1,2,4,5,7,8,10,11]
...
for idx,i in enumerate(U_full):
    print( f"node {idx//3+1} idx {idx} displacement: {i}")

# node 1 idx 0 displacement: 0.0
# node 1 idx 1 displacement: 0.0
# node 1 idx 2 displacement: 0.0
# node 2 idx 3 displacement: 0.000623076923076923
# node 2 idx 4 displacement: 0.0
# node 2 idx 5 displacement: 0.0
# node 3 idx 6 displacement: 0.0003461538461538462
# node 3 idx 7 displacement: 0.0
# node 3 idx 8 displacement: 0.0
# node 4 idx 9 displacement: 0.0
# node 4 idx 10 displacement: 0.0
# node 4 idx 11 displacement: 0.0
